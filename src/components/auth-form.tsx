...
import { LoaderCircle, KeyRound, Smartphone, Mail } from 'lucide-react';
            ...
            <Form {...otpForm}>
              <form onSubmit={otpForm.handleSubmit(onOtpSubmit)} className="space-y-6">
                ...
                <Button type="submit" className="w-full" disabled={isLoading}>
                 ...
                 <Button variant="link" size="sm" className="w-full" onClick={() => { setStep('contact'); contactForm.reset(); otpForm.reset(); }}>
